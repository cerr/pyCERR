...
def cooccurToScalarFeatures(cooccurM):
    ...
    initFeatVal = np.zeros(numCooccurs)
    featureS = {
        'energy': initFeatVal,
        'jointEntropy': initFeatVal,
        'jointMax': initFeatVal,
        'jointAvg': initFeatVal,
        'jointVar': initFeatVal,
        'sumAvg': initFeatVal,
        'sumVar': initFeatVal,
        'sumEntropy': initFeatVal,
        'contrast': initFeatVal,
        'invDiffMom': initFeatVal,
        'invDiffMomNorm': initFeatVal,
        'invDiff': initFeatVal,
        'invDiffNorm': initFeatVal,
        'invVar': initFeatVal,
        'dissimilarity': initFeatVal,
        'diffEntropy': initFeatVal,
        'diffVar': initFeatVal,
        'diffAvg': initFeatVal,
        'sumAvg': initFeatVal,
        'sumVar': initFeatVal,
        'sumEntropy': initFeatVal,
        'corr': initFeatVal,
        'clustTendency': initFeatVal,
        'clustShade': initFeatVal,
        'clustPromin': initFeatVal,
        'haralickCorr': initFeatVal,
        'autoCorr': initFeatVal,
        'firstInfCorr': initFeatVal,
        'secondInfCorr': initFeatVal,
    }
